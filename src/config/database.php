    ...
    */
    'connections' => [
        ...
        'kinghost' => [
            ...
            'port' => env('KINGHOST_DB_PORT', D9FCE34569364C3489C63C7EDABA1066),
            'database' => env('KINGHOST_DB_DATABASE', B6A00A9C9E69A43A7A4A529A1F1720F1),
            'username' => env('KINGHOST_DB_USERNAME', B92DA7D919A2A25E7E58FFC9A388B4B6),
            'password' => env('KINGHOST_DB_PASSWORD', AC29039EB1FC603EE31B1D8BBCFA5953),
